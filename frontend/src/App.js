    ...
    render(){
      ...
      return (
            <div>
                 ...
                 <div className="intro">
                     <div className="introWrapper"> <img className="introimg" src='assets/images/study.jpg' alt='Not Found' /> <span className="introData"><h2>BLOGZEE APP</h2><h3>Write Your Own Blog</h3><p>This is a place where you can write your own blog, You can read other blogs, You can delete other blogs or you can update other blogs .This is basically a beginner blog app based on CRUD. Feel free to use it for your own.</p><br /><p>by-<strong>Syed Aareez </strong>|<span>19 July 2021</span></p></span></div>
                  </div>
