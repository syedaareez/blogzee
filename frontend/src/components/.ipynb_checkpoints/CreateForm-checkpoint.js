...
updateFunc(){
    ...
    this.setState({activeItem:{title:this.state.Update.con.title,content:this.state.Update.con.content,author:this.state.Update.con.author,image:this.state.Update.con.image},Update:null,updateRan:true,updateId:this.state.Update.con.id})
